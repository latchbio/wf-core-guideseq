...
# ONLY EDIT THIS FILE FROM WITHIN THE 'LATCHBIO/BOILERPLATE' REPOSITORY:
...
git clone https://github.com/latchbio/boilerplate.git "${OUT}" 

echo "Updating the update.sh script."
cp "${OUT}/boilerplate/update.sh" "${DIR}/update.sh"

CONFIG_FILE="${DIR}/update.cfg"
README="https://github.com/latchbio/boilerplate/blob/master/Readme.rst"
